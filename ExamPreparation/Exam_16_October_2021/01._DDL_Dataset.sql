...
(5,'RAMON', 'Ram�n Allones is the name of two premium cigar brands, one produced on the island of Cuba for Habanos SA, the Cuban state-owned tobacco company, and other produced in Honduras for General Cigar Company, now a subsidiary of Swedish Match.'),
...
(11,'DIPLOMATICOS', 'Diplom�ticos is the name of a premium cigar brand, produced on the island of Cuba for Habanos SA, the Cuban state-owned tobacco company, at the Jos� Mart� factory in Havana.'),
...
In July 1935, Alonso Men�ndez purchased the Particulares Factory, makers of the popular Particulares brand and the lesser-known Byron. Immediately after its acquisition, he created a new brand named Montecristo.
The name for the brand was inspired by the Alexandre Dumas, p�re novel The Count of Monte Cristo, which was supposedly a very popular choice among the torcedores (cigar rollers) in their factory to have read by the lector on the rolling floor. The now-famous Montecristo logo, consisting of a triangle of six swords surrounding a fleur-de-lis, was designed by John Hunter Morris and Elkan Co. Ltd., the brand''s British distributor.
In July 1936, Men�ndez founded a new firm with a partner, naming it Men�ndez, Garc�a y C�a. With the growing success of the Montecristo brand, the firm purchased the faltering H. Upmann Factory (created by Hermann Dietrich Upmann in 1844) from J. Frankau SA in 1937 and transferred Montecristo production there. J. Frankau continued as sole distributor of the H. Upmann brand in the UK, while John Hunter Morris and Elkan Co. Ltd. was the sole distributor of Montecristo in Britain. In 1963, these firms merged to become Hunters & Frankau, which today is the sole importer and distributor of all Cuban cigars in the UK.
...
Men�ndez and Garc�a re-established their brand in the Canary Islands, but were later forced to quit due to trademark disputes with Cubatabaco (later known as Habanos S.A.). In the mid-1970s, the operation was moved to La Romana and released for the US market, since Cuban government rights to the brand were not recognized under American law due to the 1960 nationalization and subsequent embargo. Men�ndez, Garc�a, y C�a is now owned by Altadis S.A., who controls its distribution and marketing in the United States.
With Menendez and Garcia gone after 1959, one of the top grade torcedores, Jos� Manuel Gonz�lez, was promoted to floor manager and proceeded to breathe new life into the brand. In the 1970s and 1980s, five new sizes were added: the A, the Especial No. 1 and 2, the Joyita, and the Petit Tubo. Three other sizes, the Montecristo No. 6, No. 7, and B, were released but subsequently discontinued, though the B can occasionally be found in very small releases each year in Cuba. Through the 1970s and 1980s, Montecristo continued to rise in popularity among cigar smokers, becoming one of Cuba''s top selling cigar lines.'),
(19, 'PUNCH', null)
...
(14,'ROMEO-Y-JULIETA FABULOSOS NO. 2 - HABANOS COLECCI�N 2016 BOOK', 4, 4, 16, 95.77,'ROMEO-Y-JULIETA-no.-4.jpg'),
...
(10,'San Jos�','Costa Rika','55 Peregrine Heath','174PO02'),
